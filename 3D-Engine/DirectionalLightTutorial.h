#ifndef DIRECTIONAL_LIGHT_TUTORIAL_H
#define DIRECTIONAL_LIGHT_TUTORIAL_H
...
class DirectionalLightTutorial
{
public:
	...
	DirectionalLightTutorial()
	{
		lightingShader = Shader("../directionalLight.vs", "../directionalLight.fs");
...
#endif // !DIRECTIONAL_LIGHT_TUTORIAL_H
