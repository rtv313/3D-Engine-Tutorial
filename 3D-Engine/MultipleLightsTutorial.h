#ifndef MULTIPLE_LIGHTS_TUTORIAL_H_
#define MULTIPLE_LIGHTS_TUTORIAL_H_
...
public:
	...
	MultipleLightsTutorial()
	{
		lightingShader = Shader("../MultipleLights.vs", "../MultipleLights.fs");
...
#endif // !MULTIPLE_LIGHTS_TUTORIAL_H_
